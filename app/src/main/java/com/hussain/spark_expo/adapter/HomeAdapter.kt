...
class HomeAdapter(private val ordersList: List<Temp>) :
    RecyclerView.Adapter<HomeAdapter.OrderViewHolder>() {
    ...
    override fun onBindViewHolder(holder: OrderViewHolder, position: Int) {
        ...
        // Assigning Order ID (retrieved from Firestore)
        ...
        // Hardcoded "Delivered" status (can be updated dynamically)
